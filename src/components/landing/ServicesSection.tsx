...
const services = [
  ...
  },
  {
    ...
    description: 'Bridge the gap between your tools. Our custom VB.NET and Python automation engines streamline workflows that off-the-shelf software can’t touch.',
    icon: Zap,
